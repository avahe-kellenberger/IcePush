...
public class UIComponent {
    ...
    public void setVisible(boolean visible) {
        ...
        if (parent != null) parent.positionChildren();
    }
    ...
    public void updateAbsoluteLocation() {
        ...
        if (parent != null) setAbsoluteLocation(parent.abs_x + x, parent.abs_y + y);
        else setAbsoluteLocation(x, y);
    }
    ...
    public boolean handleAction(Actions actionType, int x, int y) {
        ...
        if (getVisible() && getRect().contains(x, y)) {
            if (actionType == Actions.CLICK) action = getClickAction();
            else if (actionType == Actions.HOVER) action = getHoverAction();
            else if (actionType == Actions.PRESS) action = getMousePressAction();
            else if (actionType == Actions.RELEASE) action = getMouseReleaseAction();
            if (action != null) {
