...
public class Button extends UIComponent {
    ...
    protected void drawComponent(Graphics g) {
        ...
        // Subtract 1 at the end of the height calculation because it looks more centered on the 3D
        // button that way
        g.drawString(
                caption,
                (abs_x + width / 2 - captionWidth / 2),
                (abs_y + height / 2 + fontHeight / 2 - fontDescent - 1));
    }
}
