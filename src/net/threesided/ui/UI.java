...
public class UI extends Container {
    ...
    public UI(int width, int height) {
        ...
        String[] instructionsText =
                new String[] {"Push the other players off the ice!", "Try not to fall off!"};
        String[] helpText =
                new String[] {
                    "Arrow keys - move",
        ...
        for (String line : instructionsText) instructionsContainer.addChild(new Label(line));
        ...
        for (String line : helpText) helpTextContainer.addChild(new Label(line));
