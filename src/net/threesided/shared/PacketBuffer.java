...
public class PacketBuffer extends Buffer {
    ...
    protected static final int PING =
            -37; // TODO: Make this consistent with the rest of the opcodes
    ...
    public int pingTimeout =
            7000; //	Amount of time to drop the connection if no packets are recieved
    ...
    public void beginPacket(int opcode) {
        pktStart = writePtr;
        writePtr +=
                2; // Reserve two bytes at the beginning for the size, which can't be computed until
                   // endPacket()
        writeByte(opcode);
    }
    ...
    public void endPacket() {
        ...
        writeShort(
                saveWritePtr
                        - pktStart); // Write size to the reserved space: size = curent - start.
    ...
    public boolean synch() {
        ...
        try {
            ...
            if (numBytesUnread + available < 0) return false;
