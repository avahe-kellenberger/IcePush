...
public class MapMaker extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (cmd.equals("New")) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Enter a number for width and height!");
            }
    ...
    private void updateLevelLabelText() {
        for (int k = 0; k < mapPanel.getComponents().length; k++) {
            ...
            if (c.isVisible()) heightLabel.setText("Height level: " + k);
        }
    }
    ...
    class ClickLabel extends JLabel implements MouseListener {
        ...
        private void updateBg() {
            if (flag == 3) setBackground(Color.red);
            else if (flag == 2) setBackground(Color.green);
            else if (flag == 1) setBackground(Color.black);
            else if (flag == 0) setBackground(Color.white);
