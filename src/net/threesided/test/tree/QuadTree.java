package net.threesided.test.tree;
...
class QtNode {
    ...
    public QtNode getNodeContaining(int px, int py) {
        ...
        switch (q) {
            case 0:
                return n1 == null ? this : n1.getNodeContaining(px, py);
            case 1:
                return n2 == null ? this : n2.getNodeContaining(px, py);
            case 2:
                return n3 == null ? this : n3.getNodeContaining(px, py);
            case 3:
                return n4 == null ? this : n4.getNodeContaining(px, py);
        }
