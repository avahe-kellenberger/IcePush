...
import static net.threesided.shared.Opcodes.CHAT_REQUEST;
import static net.threesided.shared.Opcodes.END_MOVE;
import static net.threesided.shared.Opcodes.KEEP_ALIVE;
import static net.threesided.shared.Opcodes.LOGOUT;
import static net.threesided.shared.Opcodes.MOVE_REQUEST;
import static net.threesided.shared.Opcodes.NEW_CHAT_MESSAGE;
import static net.threesided.shared.Opcodes.NEW_PLAYER;
import static net.threesided.shared.Opcodes.PING;
import static net.threesided.shared.Opcodes.PLAYER_DIED;
import static net.threesided.shared.Opcodes.PLAYER_LOGGED_OUT;
import static net.threesided.shared.Opcodes.PLAYER_MOVED;
import static net.threesided.shared.Opcodes.SUCCESS_LOG;
import static net.threesided.shared.Opcodes.TOO_MANY_PL;
import static net.threesided.shared.Opcodes.UPDATE;
import static net.threesided.shared.Opcodes.UPDATE_ROUNDTIME;
import static net.threesided.shared.Opcodes.USER_IN_USE;
import static net.threesided.shared.Opcodes.VERSION;
