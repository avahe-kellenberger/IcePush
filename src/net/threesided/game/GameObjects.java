...
public class GameObjects {
    ...
    public static Action onUsernameTextBoxClick =
            new Action() {
    ...
    public static Action onServerTextBoxClick =
            new Action() {
                public void doAction(UIComponent uiComp, int x, int y) {
    ...
    public static Action onSelectButtonClick =
            new Action() {
                public void doAction(UIComponent uiComp, int x, int y) {
    ...
    public static Action onLineButtonClick =
            new Action() {
                public void doAction(UIComponent uiComp, int x, int y) {
    ...
    public static Action onQuadButtonClick =
            new Action() {
                public void doAction(UIComponent uiComp, int x, int y) {
    ...
    public static Action onCubicButtonClick =
            new Action() {
                public void doAction(UIComponent uiComp, int x, int y) {
    ...
    public static Action onCloseButtonClick =
            new Action() {
                public void doAction(UIComponent uiComp, int x, int y) {
    ...
    public static Action onExportButtonClick =
            new Action() {
                public void doAction(UIComponent uiComp, int x, int y) {
    ...
    public static Action onImportButtonClick =
            new Action() {
                public void doAction(UIComponent uiComp, int x, int y) {
